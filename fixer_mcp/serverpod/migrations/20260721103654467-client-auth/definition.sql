...
--
-- Class AppEvent as table app_event
--
CREATE TABLE "app_event" (
    "id" bigserial PRIMARY KEY,
    "appThreadId" bigint NOT NULL,
    "turnId" bigint,
...
-- Indexes
CREATE UNIQUE INDEX "app_event_thread_sequence_idx" ON "app_event" USING btree ("appThreadId", "sequence");
CREATE INDEX "app_event_thread_created_idx" ON "app_event" USING btree ("appThreadId", "createdAt");

--
-- Class AppThread as table app_thread
--
CREATE TABLE "app_thread" (
    ...
    "role" text NOT NULL,
    "projectRoot" text,
    "linkedFixerSessionId" bigint,
    "provider" text NOT NULL,
    "providerSessionId" text,
    "status" text NOT NULL,
    "model" text,
    "reasoning" text,
    "selectedMcp" json NOT NULL,
    "writeScope" text,
    "lastTurnId" bigint,
...
-- Indexes
CREATE INDEX "app_thread_provider_session_idx" ON "app_thread" USING btree ("provider", "providerSessionId");

--
-- Class AppTurn as table app_turn
--
...
-- Indexes
CREATE UNIQUE INDEX "app_turn_thread_sequence_idx" ON "app_turn" USING btree ("appThreadId", "sequence");

--
-- Class ClientUser as table client
--
CREATE TABLE "client" (
...
--
-- Class ProviderProcessRun as table provider_process_run
--
CREATE TABLE "provider_process_run" (
    "id" bigserial PRIMARY KEY,
    "appThreadId" bigint NOT NULL,
    "turnId" bigint,
...
-- Indexes
CREATE INDEX "provider_process_run_thread_started_idx" ON "provider_process_run" USING btree ("appThreadId", "startedAt");

--
-- Class ProviderSession as table provider_session
--
CREATE TABLE "provider_session" (
    ...
    "cwd" text,
    "externalLogPaths" json,
    "createdAt" timestamp without time zone NOT NULL
);

-- Indexes
CREATE UNIQUE INDEX "provider_session_external_idx" ON "provider_session" USING btree ("provider", "providerSessionId");
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('fixer_dashboard', '20260721103654467-client-auth', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260721103654467-client-auth', "timestamp" = now();
